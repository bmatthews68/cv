...
At Newbay I developed and maintained Newbay's SyncDrive product, which was a white label application offered to mobile phone operators to allow users synchronize content between their PCs, mobile devices and cloud based storage.
...
At TerraNua, I was mainly responsible for designing the architecture and overseeing the implementation of MyComplianceOffice (http://www.mycomplianceoffice.com/).
...
I designed the physical and software architecture for MyComplianceOffice, recruited and led the development team for release 1.0, led the architecture team.

* Established the engineering practices.

* Introduced SCRUM to manage the development phase of the project.

I went on-site to recruit and mentor an offshore development team in Tunisia.
