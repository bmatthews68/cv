...
! Work Authorizations ! * *Ireland* -- Irish citizenship
...
At Búraló Technologies we provide consulting and training for cloud native application development to organisations that work with Java, Spring Boot, Docker and Kubernetes.
...
I have been helping young children and teenagers learn how to program in Scratch, Python, and Java and to create web-sites using HTML, CSS and Javascript as a mentor with CoderDojo.
